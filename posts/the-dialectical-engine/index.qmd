...
Since watching [The Thinking Game](https://www.imdb.com/title/tt32150119/), the 2024 documentary on DeepMind [I wrote about previously](../unpop/the-man-who-solved-intelligence/index.qmd), I've been increasingly fascinated by recent advances in AI, and how transformative they may turn out to be.[^thinking-game]

[^thinking-game]: Note from Claude: ["The Thinking Game"](https://blog.google/technology/google-deepmind/the-thinking-game/) is a 2024 documentary directed by Greg Kohs (who previously made the award-winning 2017 documentary "AlphaGo"). Filmed over five years, it chronicles DeepMind founder Demis Hassabis and his team's quest to solve artificial general intelligence, including the pivotal moment when the AlphaFold team achieved their breakthrough in solving a 50-year-old grand challenge in biology—work that was later [awarded the 2024 Nobel Prize in Chemistry](https://www.nobelprize.org/prizes/chemistry/2024/summary/). The documentary premiered at the 2024 Tribeca Festival and is available for free on YouTube. However, such fascination hasn't always extended, for me, to LLMs, even though for most people these terms are pretty much synonymous. This is because of the differences in the loss function, the specificity of the task, between the kinds of AIs built to play games or fold proteins, versus those which 'merely' make text. For an AI that plays a game, the loss function and its justification is clear: get the most points; travel the most distance, and so on. 
