...
The [next part of this series](../lms-are-glms-part-06/index.qmd) shows how log likelihood functions tend to be used in practice, in conjunction with optimisation algorithms that (usally) arrive at good estimates of our coefficients in far fewer steps than we've used above.[^claude-mle]
