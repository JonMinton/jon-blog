...
The [start of this blog series](../../intro-to-glms/lms-are-glms-part-01/index.qmd) aimed to do two things: 
...
The rest of the first section of the series - posts two, three and four - added more context to the first post, and introduced the concept of using models for prediction - and the types of quantities of interest they can predict. The first section ended with [post four](../../intro-to-glms/lms-are-glms-part-04/index.qmd), which illustrated some of the complexities of getting meaningful effect estimates - the overall effect of one specific predictor variable on the outcome being predicted - for model structures under than standard linear regression. 
...
Now let's extend the story to convert the analogy of [the barefoot-and-blind person from part seven](../../likelihood-and-simulation-theory/lms-are-glms-part-07/index.qmd) as well:
...
Let's now do some Bayesian modelling to compare...[^claude-optimization]
