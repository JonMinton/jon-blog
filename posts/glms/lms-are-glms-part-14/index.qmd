...
Later posts will explore and expand on the above idea - that causal inference relies on counterfactuals, but counterfactuals are by definition unobserved - and give a more technical treatment about the challenges and techniques involved in trying to grapple with causal effect estimation in statistical models.
