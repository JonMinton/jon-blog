...
Compared with OpenAI's CEO Sam Altman, [Demis Hassabis](https://en.wikipedia.org/wiki/Demis_Hassabis), the cofounder of [DeepMind](https://en.wikipedia.org/wiki/Google_DeepMind), is perhaps less well know amongst the general public. However, after watching [The Thinking Game](https://www.imdb.com/title/tt32150119/) recently, the 2024 documentary tracking DeepMind's staggering progress towards Artifical General Intelligence (AGIs), Hassabis may well turn out to have been the more impactful in the course of human cultural and technological evolution. Founding the company in 2010 with the modest goal of 'solving intelligence', DeepMind was then acquired by Google in 2014 for an unfathonable amount of money, after being able to show remarkable success in teaching AIs to solve complex but well defined goal-orientated activities.
