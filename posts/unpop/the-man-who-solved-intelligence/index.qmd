...
Step forward to 2024. Hassabis is a recipient of the Nobel Prize in Chemistry.^[Note from Claude: Demis Hassabis and John Jumper were [awarded the 2024 Nobel Prize in Chemistry](https://www.nobelprize.org/prizes/chemistry/2024/press-release/) for developing AlphaFold2, which solved the 50-year-old protein structure prediction problem. This marked [the first time AI-enabled research from a tech company](https://www.nature.com/articles/d41586-024-03214-7) (DeepMind, acquired by Google in 2014) received a Nobel Prize. AlphaFold2 achieved 90% accuracy in predicting protein structures and has been used by over 2 million researchers in 190 countries. The model has predicted structures for hundreds of millions of proteins, fundamentally transforming drug discovery, enzyme engineering, and basic biological research.] AlphaFold has predicted the protein structure of almost every protein ever discovered. Rather than hoarding such knowledge, perhaps equivalent to millennia of human endeavour, DeepMind releases all predictions.
