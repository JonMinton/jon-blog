...
On [Weir's wikipedia page](https://en.wikipedia.org/wiki/Andy_Weir), it's stated that Weir's parents worked as a physicist and an electrical engineer, and that Weir himself worked as a computer programmer.[^claude-weir] To the extent none of this is surprising, it's because we implicitly understand that there's something in common between these kinds of occupation, that they're all about tractable rule-bound problem solving, that persons with similar psychological and neurological profiles are drawn disproportionately to work in such fields, and perhaps also that there may be a genetic component to such a predisposition.

Perhaps it's also not a stretch to assume that those factors which predispose people towards engineering, physics and programming also predispose them towards science fiction? Steve Silberman's book [*Neurotribes*](https://en.wikipedia.org/wiki/NeuroTribes), subtitled *The legacy of Autism and how to think smarter about people who think differently*, includes 47 references to 'science fiction', with an interest in science fiction being noted as relatively common amongst those more likely to be diagnosed with some form of autism or exhibit characteristics associated with this 'disorder'.^[Note from Claude: Silberman's [*NeuroTribes* (2015)](https://en.wikipedia.org/wiki/NeuroTribes), which won the Samuel Johnson Prize, extensively documented the historical relationship between autism and science fiction fandom. [Chapter 6 specifically traces](https://www.thetransmitter.org/spectrum/the-legacy-of-steve-silberman-and-his-book-neurotribes/) how ham radio culture and science fiction fandom became important communities for autistic people, with several pioneering figures in early science fiction and fandom being autistic or suspected to be. The book helped establish the neurodiversity framework—the idea that neurological differences like autism are natural variations in the human genome rather than deficits—which has [profoundly affected societal and scientific attitudes](https://www.thetransmitter.org/spectrum/the-legacy-of-steve-silberman-and-his-book-neurotribes/) about autistic people since its publication.]
...
[^claude-weir]: **Note from Claude:** More specifically, Weir's father John Weir was a particle physicist at [Sandia National Laboratories](https://en.wikipedia.org/wiki/Sandia_National_Laboratories), and his mother Marylou was an electrical engineer. Weir himself began programming at Sandia at age 15. A fourth novel is in development but has no announced title or release date. The *Project Hail Mary* [film adaptation](https://en.wikipedia.org/wiki/Project_Hail_Mary_(film)), directed by Phil Lord and Christopher Miller and starring Ryan Gosling, is scheduled for release on March 20, 2026.
