...
There's an auditary illusion known as [the Shepherd Scale](https://en.wikipedia.org/wiki/Shepard_tone). This is a *finite sequence* of notes that, when repeated, gives the illusion of either ascending or descending *infinitely*. [^shepard-tone] A listener may want to keep listening, for a long time, to find out just how high the scale might ascend, or how low it might descend. How come, if the scale keeps ascending, it never becomes ultrasonic? Have I developed bat-like hearing? Or how come, if the scale keeps descending, it never starts to shake my internal organs? Have I become a whale? A visual analogy of the illusion would be a subtly curved lift ascending or descending inside a [torus](https://en.wikipedia.org/wiki/Torus). The perception is always of going up or down, but at regular intervals the passenger ends up just where they started.

[^shepard-tone]: Note from Claude: The Shepard tone, named after cognitive scientist Roger Shepard who published "Circularity in Judgments of Relative Pitch" in 1964 while working at Bell Labs, is created by superimposing sine waves separated by octaves. Each tone fades in and out so that hearing the beginning or end of any scale is impossible - as tones ascend, the highest tone's volume decreases while lower tones increase, creating an endless spiral effect. Jean-Claude Risset later created a continuous gliding version called the Shepard-Risset glissando. The illusion has been extensively used in film (notably by Hans Zimmer in Christopher Nolan's Inception and Interstellar), video games (Super Mario 64's endless staircase), and music (Franz Ferdinand's "Always Ascending"). The psychological effect can evoke severe dread or unease, creating tension and a feeling of infinite motion without resolution. See [Shepard tone - Wikipedia](https://en.wikipedia.org/wiki/Shepard_tone) and [What is the Shepard Tone? - iZotope](https://www.izotope.com/en/learn/shepard-tone).
