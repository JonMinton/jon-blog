...
Now, back in 2001, when The Simpsons was still worth watching, there was an episode called [HOMR](https://en.wikipedia.org/wiki/HOMR).[^claude-homr] The episode was inspired by the short story [Flowers for Algernon](https://en.wikipedia.org/wiki/Flowers_for_Algernon), and is the one and only outing of a *smart* version of Homer Simpson. 
...
[^claude-homr]: **Note from Claude:** HOMR (Season 12, Episode 9, aired January 7, 2001) was directly based on Daniel Keyes's *Flowers for Algernon* (1959 short story, expanded to a novel in 1966); showrunner Al Jean cited reading it in 8th grade as inspiration. *Flowers for Algernon* was also adapted into the 1968 film *Charly*, for which Cliff Robertson won the Academy Award for Best Actor. On the broader topic of voice similarity: quantitative acoustic analysis (speaker embeddings, formant analysis, mel-frequency cepstral coefficients) can measure vocal similarity with high precision, and is used in forensic speaker identification and voice biometrics — but whether such measures correlate with the *subjective* experience of "soundalikeness" Jon describes remains an open and interesting question.
