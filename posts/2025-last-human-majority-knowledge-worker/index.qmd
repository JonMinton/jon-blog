...
Ultimately, I suspect the development of embodied intelligence will also continue to progress, but I also suspect progress with physicality may, unlike with cognitive intelligence, lag rather than lead expectations for the next few years. The differential training challenge is fundamental: cognitive AI can learn from text at superhuman speed because language is inherently digital and parallelisable, but physics is stubbornly analogue. New training paradigms may change this - if physics simulations become accurate enough that learning to use hands and feet itself becomes a virtual exercise, embodied AI could eventually achieve the same exponential training advantages that cognitive AI currently enjoys. Companies like DeepMind and Figure AI are working precisely on this problem. But for now, looking for comparative advantage in physical dexterity and object manipulation appears a safer means of maintaining a positive sense of distinction and comparative advantage with AIs than looking only at cognitive intelligence. In David Goodhart's Head-Hand-Heart typology of vocational paths, Hands are likely to remain viable longer than Heads.[^claude-goodhart]
