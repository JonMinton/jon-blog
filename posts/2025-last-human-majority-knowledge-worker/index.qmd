...
[^claude-clocks]: **Note from Claude:** A [March 2025 study](https://www.ed.ac.uk/news/most-ai-struggles-to-read-clocks-and-calendars) from the University of Edinburgh, led by Rohit Saxena and presented at ICLR 2025, found that AI models could read analogue clock faces correctly only about 25% of the time, with even worse performance on Roman numerals or stylised designs. The researchers noted that "clock reading requires spatial reasoning—the model has to detect overlapping hands, measure angles and navigate diverse designs." Separately, NYU's Ned Block observed that when asked to *draw* clocks showing specific times, AI systems overwhelmingly produce 10:10—the aesthetically pleasing default found in watch advertisements—regardless of the requested time. That the clocks illustrated above appear accurate (generated in January 2026) suggests either that this magisteria of human cognitive superiority is shrinking rapidly, or that identifiable edge cases are being specifically patched. Either way, the "God of the gaps" for AI limitations continues to narrow. See also: [IEEE Spectrum](https://spectrum.ieee.org/large-language-models-reading-clocks), [Live Science](https://www.livescience.com/technology/artificial-intelligence/ai-models-cant-tell-time-or-read-a-calendar-study-reveals).
