...
I had the privilege yesterday of hearing a series of talks by researchers at the University of Glasgow on 20 minute neighbourhoods.[^1] The talks covered areas like evidence surveys of health associations, GIS methods,[^2] and engagement with historical amenities.^[Note from Claude: Research evidence on walkable neighborhoods has continued to accumulate since this post. A [2025 study of cardiovascular health in Shanghai](https://www.frontiersin.org/journals/public-health/articles/10.3389/fpubh.2025.1687414/abstract) found significant health benefits from 15-minute walkable neighborhoods, particularly for older adults. [Twin studies](https://pmc.ncbi.nlm.nih.gov/articles/PMC8776244/) have demonstrated strong correlations between walkable neighborhoods, time spent walking, and positive health outcomes, while controlling for genetic factors. Research consistently shows walkable communities reduce obesity, NCDs, fuel consumption, and emissions while increasing physical activity and social capital.]
